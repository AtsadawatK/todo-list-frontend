...
export const UpdateCheckedTasks = async (checked) => {
    try {
        ...
        if (response.ok) {
            console.log(data.message); // แสดงข้อความเมื่ออัปเดตสำเร็จ
            // อาจไม่จำเป็นต้องเรียก updateTasks ที่นี่ ขึ้นอยู่กับลอจิกของคุณ
        } else {
