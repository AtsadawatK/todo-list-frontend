    ...
    <div class="flex justify-center h-[100vh] items-center w-full">
     {/*  <div className="w-full h-40 bg-gray-200 rounded-lg animate-shimmer bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 bg-[length:200%_100%]"></div> */}
      ...
      <div class="flex flex-col border  xs:w-[100%] md:w-[75%] lg:w-[60%] xl:w-[45%] xs:h-[100%] md:h-[85%] xs:p-[20px] md:p-[30px]  rounded-xl bg-[#F5F5F7]">
        ...
        <div class="flex  items-center justify-between w-[100%] xs:text-[18px]  md:text-[20px] font-semibold pt-5">
          <div>
          Edit Task
          </div>
          <div class="flex flex-[1] justify-end  h-[100%]">
              <div class="flex justify-center items-center xs:w-[40%] sm:w-[30%] md:w-[25%] h-[100%] bg-[#B7B7B7] hover:bg-[#473b35]  text-[18px]  text-[black] font-semibold rounded-xl cursor-pointer" onClick={LinkToHome}>
      ...
      />
        ...
        <div class="my-3 border bg-[#705C53] flex justify-center items-center h-[10%] rounded-md text-[18px]  text-[#F5F5F7] font-semibold cursor-pointer" onClick={handleUpdateTask}>
            Edit Task
        </div>
