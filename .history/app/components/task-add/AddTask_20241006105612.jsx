...
export default function AddTask() {
  ...
  const handleAdd = async () => {
    setTitleError(!title);          // ถ้า title ว่างให้แสดง error
  setDescriptionError(!description);  // ถ้า description ว่างให้แสดง error
    ...
    <div class="flex justify-center h-[100vh] items-center w-full">
     {/*  <div className="w-full h-40 bg-gray-200 rounded-lg animate-shimmer bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 bg-[length:200%_100%]"></div> */}
      ...
      <div class="flex flex-col border  w-[40%] h-[85%] p-[30px]  rounded-xl bg-[#F5F5F7]">
        ...
        <div class="flex text-[20px]">Title  <div class="flex px-2 text-[red]">
    {titleError && <span class="text-red-500 text-[16px] ml-2">* Title is required</span>}
  </div></div>
        <div class="py-3">
        ...
        onChange={(e) => {
          ...
          setTitleError(!e.target.value);  // ถ้ากรอกข้อมูลให้เอา * ออก, ถ้าไม่กรอกให้แสดง *
        }}
        ></input>
        </div>

        <div class="flex text-[20px]">Description <div class="flex px-2 text-[red]">* {descriptionError && <span class="text-red-500 text-[16px] ml-2">Description is required</span>}</div></div>
        <div class="py-3">
        ...
        <div class="flex text-[20px]">Date <div class="flex px-2 text-[red]">*  {dateError && <span class="text-red-500 text-[16px] ml-2">Date is required</span>}</div></div>
