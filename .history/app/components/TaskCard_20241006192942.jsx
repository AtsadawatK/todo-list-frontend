...
<div className="text-[18px]">{`You have ${remainingTasksCount} tasks left!`}</div>
            ...
            <div class="flex flex-[1] justify-end ">
              ...
              <div class="flex justify-center items-center xs: md:w-[50%] h-[100%] bg-[#705C53] hover:bg-[#473b35]  md:text-[16px] lg:text-[18px] text-[#F5F5F7] font-semibold rounded-xl cursor-pointer" onClick={LinkToAddTask}>
                Add a new task
              </div>
            </div>
          </div>
