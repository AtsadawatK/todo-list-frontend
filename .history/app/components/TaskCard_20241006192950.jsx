...
{/* <div class="skeleton"></div> */}
      ...
      <div class="flex flex-col border xs:w-[100%] md:w-[75%] lg:w-[60%] xl:w-[45%] xs:h-[100%] md:h-[85%] p-[30px]  rounded-xl bg-[#F5F5F7] max-w-[1080px]">
...
<div className="text-[18px]">{`You have ${remainingTasksCount} tasks left!`}</div>
            ...
            <div class="flex flex-[1] justify-end ">
              ...
              <div class="flex justify-center items-center xs:w-[70%] md:w-[50%] h-[100%] bg-[#705C53] hover:bg-[#473b35]  md:text-[16px] lg:text-[18px] text-[#F5F5F7] font-semibold rounded-xl cursor-pointer" onClick={LinkToAddTask}>
                Add a new task
              </div>
            </div>
          </div>
